# MythicPlusBox — Project Guide for Codex

This document orients Codex (and any human collaborator) to the codebase, the
...
├── .Codex/commands/release.md        Codex command that drives releases
...
Releases are cut through the Codex slash command at
`.Codex/commands/release.md`. In short:
